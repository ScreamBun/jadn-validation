...
j_schema = {
  ...
  "types": [
    ...
    ["Results", "Map", ["{1"], "", [
        [1, "versions", "ArrayOf", ["*Version", "q", "[0", "]0"], "List of OpenC2 language versions supported by this Actuator"],
...
def test_response():
    ...
    data = {
      "status": 102,
      "status_text": "successful processing test",
      "results": {
        "versions": ["test1", "test2"],
        "profiles": ["1234567890123456"],
        "pairs": {
          "locate": ["artifact", "command"]
        }
      }
    }
