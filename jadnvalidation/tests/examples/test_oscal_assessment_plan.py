...
j_schema = {
  ...
  "types": [
    ["Root", "Record", [], "", [
        ...
        [2, "assessment-plan", "Assessment-plan", [], "An assessment plan, such as those provided by a FedRAMP assessor."]
      ]],
    ["Assessment-plan", "Record", [], "An assessment plan, such as those provided by a FedRAMP assessor.", [
        [1, "uuid", "UUIDDatatype", [], "A machine-oriented, globally unique identifier with cross-instance scope that can be used to reference this assessment plan in this or other OSCAL instances. The locally defined UUID of the assessment plan can be used to reference the data item locally or globally (e.g., in an imported OSCAL instance). This UUID should be assigned per-subject, which means it should be consistently used to identify the same subject across revisions of the document."],
        ...
        [3, "import-ssp", "Import-ssp", [], "Used by the assessment plan and POA&M to import information about the system."],
        [4, "local-definitions", "Local-Definitions", ["[0"], "Used to define data objects that are used in the assessment plan, that do not appear in the referenced SSP."],
        [5, "terms-and-conditions", "ArrayOf", ["*Assessment-Part", "[0"], "Used to define various terms and conditions under which an assessment, described by the plan, can be performed. Each child part defines a different type of term or condition."],
        [6, "reviewed-controls", "Reviewed-controls", [], "Identifies the controls being assessed and their control objectives."],
        [7, "assessment-subjects", "Assessment-subjects", ["[0"], "Identifies system elements being assessed, such as components, inventory items, and locations. In the assessment plan, this identifies a planned assessment subject. In the assessment results this is an actual assessment subject, and reflects any changes from the plan. exactly what will be the focus of this assessment. Any subjects not identified in this way are out-of-scope."],
        [8, "assessment-assets", "Assessment-assets", ["[0"], "Identifies the assets used to perform this assessment, such as the assessment team, scanning tools, and assumptions."],
    ...
    ["Local-Definitions", "ArrayOf", ["*Local-Definition", "{1"], ""],
    ...
    ["Control-Parts", "ArrayOf", ["{1", "*Control-Part"], "", []],
    ...
    ["Task", "Record", [], "Represents a scheduled event or milestone, which may be associated with a series of assessment actions.", [
        ...
        [5, "props", "Props", ["[0"], "An attribute, characteristic, or quality of the containing object expressed as a namespace qualified name/value pair."],
        [6, "links", "Links", ["[0"], "A reference to a local or remote resource, that has a specific relation to the containing object."],
        [7, "timing", "Task-Timing", [], "The timing under which the task is intended to occur."],
    ...
    ["Related-observation", "Record", [], "Relates the finding to a set of referenced observations that were used to determine the finding.", [
    ...
    ["Risk", "Record", [], "An identified risk.", [
        ...
        [14, "risk-log", "ArrayOf", ["*Risk-Log-Entry", "[0", "]1"], "A log of all risk-related tasks taken."],
    ...
    ["Control-Part", "Record", [], "An annotated, markup-based textual element of a control's or catalog group's definition, or a child of another part.", [
    ...
    ["System-component", "Record", [], "A defined component that can be part of an implemented system.", [
        ...
        [6, "props", "Props", ["[0"], "An attribute, characteristic, or quality of the containing object expressed as a namespace qualified name/value pair."],
        [7, "links", "Links", ["[0"], "A reference to a local or remote resource, that has a specific relation to the containing object."],
        [8, "status", "System-Component-Status", ["[1", "]1"], "Describes the operational status of the system component."],
    ...
    ["UUIDDatatype", "String", ["%^[0-9A-Fa-f]{8}-[0-9A-Fa-f]{4}-[4-5][0-9A-Fa-f]{3}-[8-9A-Ba-b][0-9A-Fa-f]{3}-[0-9A-Fa-f]{12}$"], "A type 4 ('random' or 'pseudorandom') or type 5 UUID per RFC 4122.", []],
    ...
    ["Risk-Response-Reference", "Record", [], "", [
        [1, "response-uuid", "String", [], ""],
        [2, "related-responses", "ArrayOf", ["*related-response", "[0", "]0"], ""]
      ]],
    ["Local-Definition", "Record", [], "", [
        [1, "components", "Implemented-components", ["[0", "]1"], ""],
        [2, "inventory_items", "ArrayOf", ["*Inventory-item", "[0", "]0"], ""],
        [3, "users", "ArrayOf", ["*System-user", "[0", "]0"], ""],
        [4, "objectives_and_methods", "ArrayOf", ["*Local-objective", "[0", "]0"], ""],
        [5, "activities", "ArrayOf", ["*Activity", "[0", "]0"], ""],
        [6, "remarks", "String", [], ""]
      ]]
  ]
}
...
j_schema_back_matter = {
  ...
  "types": [
    ...
    ["Resources", "ArrayOf", ["{1", "*Resource"], "", []],
    ["Resource", "Record", [], "A resource associated with content in the containing document instance. A resource may be directly included in the document using base64 encoding or may point to one or more equivalent internet resources.", [
        [1, "citation", "Resource", ["[0"], "An optional citation consisting of end note text using structured markup."],
        [2, "base64", "Resource", ["[0"], "A resource encoded using the Base64 alphabet defined by RFC 2045."]
      ]]
  ]
}
